...
public class EmailSender : IEmailSender
{
    ...
    {
        _smtpConfig = (SmtpConfig)configuration.GetSection("SmtpConfig");
    }
    ...
    private MailMessage ToMailMessage(EmailMessage message)
    {
        ...
        var mail = new MailMessage(fromEmail, message.ToEmail, message.Title, message.Body);
        return mail;
    }
}
